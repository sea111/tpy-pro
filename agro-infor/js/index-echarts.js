$(function(){
	...
	function datas(datas,ids){
		...
		/*var echartsPie5 = echarts.init(document.getElementById('echartsPie5'));
		var echartsPie6 = echarts.init(document.getElementById('echartsPie6'));
		var echartsPie7 = echarts.init(document.getElementById('echartsPie7'));
		var echartsPie8 = echarts.init(document.getElementById('echartsPie8'));	*/	
		var optionPie = {	
			tooltip: {
	            trigger: 'item',
	            //formatter: "{b}: {c} ({d}%)"//a（系列名称），b（数据项名称），c（数值）, d（百分比）
	    ...
	    /*echartsPie5.setOption(optionPie);
	    echartsPie6.setOption(optionPie);
	    echartsPie7.setOption(optionPie);
	    echartsPie8.setOption(optionPie);*/
	}
	datas([
	...
	//农村居民人均纯收入趋势
	var incomeBar=echarts.init(document.getElementById('incomBar'))			
	var incomeOption={
		tooltip:{
			trigger:'item'
		},
		...
		series:[
			{
				...
				barWidth:14,//柱的宽度
	            barGap:'26',
	            data: ['10',20,25,33,42,42,33,25,25,40]
			}
		]
	}
	incomeBar.setOption(incomeOption)
	...
	function cityPies(cur,bil,num1,num2){
		var cityPie = echarts.init(document.getElementById('cityPie'));
		var optionCityPie = {	
			/*tooltip: {
	            trigger: 'item',
	            //formatter: "{b}: {c} ({d}%)"//a（系列名称），b（数据项名称），c（数值）, d（百分比）
	...
	//              ]
	    ...
	    cityPie.setOption(optionCityPie);
	}
	cityPies([
		{value:20,name:''},
		{value:1000,name:''}
